...
function prepareObject(jsonObject) {
  ...
  //House
  student.house =
    house.charAt(0).toUpperCase() + house.substring(1).toLowerCase();
...
function renderCounts(sortedList) {
  ...
  for (let obj of allStudents) {
    ...
    document.querySelector(".fact_box [data-field=gryffindor]").textContent =
      gryffindor;
  }
  ...
  for (let obj of allStudents) {
    ...
    document.querySelector(".fact_box [data-field=slytherin]").textContent =
      slytherin;
  }
  ...
  for (let obj of allStudents) {
    ...
    document.querySelector(".fact_box [data-field=hufflepuff]").textContent =
      hufflepuff;
  }
  ...
  for (let obj of allStudents) {
    ...
    document.querySelector(".fact_box [data-field=ravenclaw]").textContent =
      ravenclaw;
  }
  ...
  for (let obj of allStudents) {
    ...
    document.querySelector(
      ".fact_box [data-field=total_non_expelled]"
    ).textContent = non_expelled;
  }
  ...
  for (let obj of allStudents) {
    ...
    document.querySelector(
      ".fact_box [data-field=total_expelled]"
    ).textContent = total_expelled;
  }

  document.querySelector(
    ".fact_box [data-field=student_showing]"
  ).textContent = `${sortedList.length}`;
}
...
function displayStudent(student) {
  ...
  clone.querySelector("[data-field=blood_status]").textContent =
    student.bloodStatus;
  clone
    .querySelector(".popup_button")
    .addEventListener("click", () => openPopup(student));
  ...
  function clickSquad() {
    if (student.bloodStatus === "pure") {
      ...
      alert(
        "Only pure bloods or non expelled students can join the Inquisitorial squad!"
      );
    }
  }
...
function openPopup(student) {
  ...
  // SHOW STUDENT INFO
  document.querySelector(".popup h3").textContent =
  ...
  // EXPEL STUDENTS
  document.querySelector(".expel_student").textContent =
    "Expel" + " " + student.firstName;
  document
  ...
  document.querySelector(".squad_member").textContent =
    "Inquisitorial squad:" + " " + "No";
  if (student.squad === true) {
    document.querySelector(".squad_member").textContent =
      "Inquisitorial squad:" + " " + "yes";
  }
